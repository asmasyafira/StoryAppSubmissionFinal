package com.example.storyappsubmission.repo
...
import com.example.storyappsubmission.data.KeyRemote
import com.example.storyappsubmission.data.StoryDatabase
import com.example.storyappsubmission.retrofit.ApiService
...
class StoryMediator(
    ...
    override suspend fun load(
        loadType: LoadType,
        state: PagingState<Int, ListStoryDetail>): MediatorResult {
